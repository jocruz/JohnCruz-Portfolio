...
const certifications = [
  {
    ...
    description:
      'An intermediate-level certification assessing the ability to conduct a full web application penetration test. Covered advanced exploitation techniques including NoSQL injection, race conditions, mass assignment, SSRF, template injection, and bypassing modern security controls.',
    logo: pwpplogo,
  },
  {
    id: 2,
    ...
    url: 'https://certified.tcm-sec.com/4a803568-86d5-4150-924f-9cc6173eff74?key=a2d2b570e775b4a2f78622e7443351b05e021fcc03edfc9961ad3456ae9a1f8a&record_view=true',
    description:
      'Hands-on certification focused on testing web applications for vulnerabilities such as Broken Access Control, SQL Injection, Cross-Site Scripting (XSS), and Security Misconfiguration.',
    logo: pjwtLogo,
  },
  {
    id: 3,
    ...
    description:
      'Validated penetration testing skills in internal network security assessments, including Active Directory exploitation, privilege escalation, and lateral movement.',
    logo: pjptLogo,
  },
  {
    id: 4,
    ...
    description:
      'Industry-standard certification covering foundational cybersecurity concepts such as network security, risk management, cryptography, and security operations.',
    logo: csLogo,
  },
];
            ...
            <div className="certifications__links">
              {url && (
                <a href={url} target="_blank" rel="noopener noreferrer">
                  View Credentials <FaExternalLinkAlt />
                </a>
              )}
            </div>
          </li>
