...
const data = [
  ...
  },
  {
    id: 4,
    image: IMG3,
    title: 'Lost Cats 2D/3D SOL Decentralized Application - Web 3 Developer / Web 3 Researcher',
...
const Portfolio = () => {
  return (
    <section id='portfolio'>
      <h5>My Recent Work That I Worked On And My Roles In The Projects, <i>if Github is unavailable it is because it was requested to be private by the client</i></h5>
      <h2>Portfolio</h2>
